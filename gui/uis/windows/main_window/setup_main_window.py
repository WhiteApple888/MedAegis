...
class SetupMainWindow:
    ...
    add_left_menus = [
        ...
        },
        {
            ...
            "btn_id" : "btn_crcl",
            "btn_text" : "CrCl Calculator",
            "btn_tooltip" : "CrCl Calculator",
            "show_top" : True,
            "is_active" : False
        },
        {
    ...
    def setup_gui(self):
        ...
        QWidget {{
            ...
            font-family: 'Segoe UI'; /* Optional: set a default font */
        }}
        """
        ...
        # ADD THEME CHANGE TOGGLE BUTTON
        self.theme_toggle = PyToggle(
            width = 40,
            bg_color = self.themes["app_color"]["dark_two"],
            circle_color = self.themes["app_color"]["icon_color"],
            active_color = self.themes["app_color"]["context_color"]
        )
        self.ui.title_bar.custom_buttons_layout.addWidget(self.theme_toggle)
        ...
        if self.settings["custom_title_bar"]:
            ...
            self.ui.title_bar.set_title("Welcome to Aegis")
        ...
        # PAGE 2 - RENAL FUNCTION PAGE
        self.crcl_page = CrClCalculatorPage(
                            self.ui, 
                            themes = self.themes
        )
